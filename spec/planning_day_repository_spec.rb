...
RSpec.describe 'PlanningDayRepository' do
  shared_examples 'valid repository' do |repository|
  ...
  context 'database repository' do
    it_behaves_like 'valid repository', Planning::Repositories::PlanningDayRepositories::Database.new
  end

  context 'in memory repository' do
    it_behaves_like 'valid repository', Planning::Repositories::PlanningDayRepositories::InMemory.new
  end
